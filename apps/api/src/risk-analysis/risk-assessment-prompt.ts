...
2. pullRequestAId, pullRequestAContribution, and pullRequestARelevantEvidenceId: the exact pullRequestA.id, only that pull request's contribution, and its most useful supporting evidence ID.
3. pullRequestBId, pullRequestBContribution, and pullRequestBRelevantEvidenceId: the exact pullRequestB.id, only that pull request's contribution, and its most useful supporting evidence ID.
...
Keep each contribution attached to the exact pull-request ID whose change it describes. The UI validates and orders contributions by these IDs. Describe only that pull request's relevant change or assumption in its contribution text.
